...
const FULL_PROGRAMMES = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Indian Railways", "Metro corporations", "Rail manufacturing units", "Signal and telecom vendors", "Rail infrastructure contractors", "DFCCIL"],
    equipment: ["Signalling relay rigs", "Track circuit simulators", "Point machine trainers", "Axle counter test kits", "Traction motor bench"],
    software: ["Railway interlocking simulation", "Track geometry analysis tools", "SCADA software", " signalling design suites"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Semiconductor fabs", "OSAT facilities", "Electronics manufacturing services", "Chip design houses", "Equipment vendors", "Testing labs"],
    equipment: ["Cleanroom training module", "Spin coater trainer", "Mask aligner simulator", "Wire bonder", "Wafer inspection microscope"],
    software: ["Process simulation tools", "Statistical process control software", "Yield management dashboards", "Cleanroom monitoring systems"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive OEMs", "Electronics assembly", "Food and beverage", "Pharmaceuticals", "System integrators", "Warehouse logistics"],
    equipment: ["6-axis articulated robot arm", "Collaborative robot (cobot)", "Robot work cell with safety fencing", "Vision camera station", "End-effector toolkit"],
    software: ["Robot teach pendant programming", "Offline robot simulation (RoboDK)", "PLC programming suites", "Vision system configuration tools"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "Consumer electronics", "Aerospace", "White goods", "Industrial machinery", "Medical devices"],
    equipment: ["Servo motor test rigs", "Pneumatic sorting station", "Stepper motor modules", "Sensor actuator kits", "CAD workstations"],
    software: ["Arduino / STM32 IDE", "CAD software (SolidWorks / Fusion 360)", "PCB design tools (KiCad)", "Oscilloscope and logic analyser software"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Smart cities", "Agriculture tech", "Industrial manufacturing", "Healthcare", "Energy and utilities", "Building management"],
    equipment: ["ESP32 development boards", "LoRa gateway and nodes", "Sensor kits (temperature, humidity, vibration)", "Edge computing modules", "Raspberry Pi units"],
    software: ["Arduino IDE / PlatformIO", "MQTT broker (Mosquitto)", "ThingSpeak / AWS IoT Core", "Grafana dashboards"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "FMCG and packaging", "Pharmaceuticals", "Steel and metals", "Electronics", "Food and beverage", "Energy and utilities", "System integrators"],
    equipment: ["PLC trainer rigs", "HMI panels", "VFD and motor sets", "Sensor and actuator kits", "Robotic work cell"],
    software: ["PLC programming suites", "SCADA software", "HMI design tools", "Process simulation software"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Process industries", "Power plants", "Water treatment", "Oil and gas", "Food and beverage", "Pharmaceuticals", "Cement and steel"],
    equipment: ["PLC trainer racks (Siemens / Allen-Bradley)", "HMI touch panels", "Process simulation rigs", "Industrial communication modules", "Field instrument kits"],
    software: ["TIA Portal / RSLogix", "SCADA software (WinCC / Ignition)", "PLCSIM virtual commissioning", "Factory I/O simulation"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive OEMs", "Consumer electronics", "Medical devices", "Aerospace and defence", "IoT product companies", "EMS manufacturers"],
    equipment: ["STM32 Nucleo boards", "ESP32 dev kits", "Logic analysers", "Oscilloscopes", "JTAG/SWD debuggers"],
    software: ["Keil / STM32CubeIDE", "FreeRTOS", "Git version control", "Protocol analyser software"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "Electronics", "Pharmaceuticals", "Food processing", "Textiles", "Metal fabrication", "System integrators"],
    equipment: ["Industrial cameras (area scan)", "NVIDIA Jetson boards", "Raspberry Pi units", "Motor test rigs with sensors", "Edge computing gateways"],
    software: ["Python (OpenCV, TensorFlow Lite)", "Grafana for dashboards", "Jupyter notebooks", "Edge AI deployment tools"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["EV OEMs", "Battery manufacturers", "Charging infrastructure companies", "Auto component suppliers", "Fleet operators", "Two-wheeler EV startups"],
    equipment: ["BLDC motor test bench", "Battery pack assembly kit", "BMS evaluation boards", "CAN bus analyser", "Charging station trainer"],
    software: ["BMS configuration software", "CAN bus analysis tools (CANalyzer)", "Motor controller tuning software", "Battery simulation tools"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "Pharmaceuticals", "FMCG", "Electronics", "Aerospace", "Heavy engineering", "Chemical plants"],
    equipment: ["OPC UA gateway", "Industrial IoT sensors", "Edge computing nodes", "MES terminal stations", "Network switches and firewalls"],
    software: ["OPC UA client/server tools", "Grafana / Power BI dashboards", "InfluxDB time-series database", "Network monitoring tools"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "Electronics", "Pharmaceuticals", "Food and beverage", "Aerospace", "White goods", "Defence"],
    equipment: ["RFID reader/writer stations", "Automated conveyor segment", "Digital work instruction terminals", "SPC measurement stations", "Barcode scanners"],
    software: ["MES/MOM software", "SPC analysis tools", "Digital work instruction platforms", "Production tracking dashboards"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "Electronics and PCB", "Pharmaceuticals", "Food and packaging", "Textiles", "Semiconductor", "Metal and glass"],
    equipment: ["Area scan cameras", "Line scan cameras", "Industrial lighting rigs (ring, back, coaxial)", "Calibration targets", "Lens toolkit"],
    software: ["OpenCV / Halcon", "Vision studio configuration tools", "PLC integration software", "Python for image analysis"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["IT and OT system integrators", "Automotive", "Power and energy", "Oil and gas", "Telecom", "Defence", "Smart infrastructure"],
    equipment: ["Managed industrial switches", "Industrial routers", "Protocol analysers", "Fibre and copper cable test kits", "Network simulation hardware"],
    software: ["Wireshark packet analyser", "Network configuration tools", "PLC communication setup software", "Firewall management interfaces"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive OEMs", "Aerospace", "Heavy engineering", "Process industries", "Smart city projects", "Defence", "Energy"],
    equipment: ["PLC with virtual commissioning setup", "Conveyor and actuator test rigs", "Camera stations for visual feedback", "PC workstations with GPU", "HMI panels"],
    software: ["Factory I/O", "PLCSIM Advanced", "TIA Portal /博途", "3D visualisation tools (Unity / Unreal basics)", "Node-RED for data flow"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Critical infrastructure", "Power and energy", "Oil and gas", "Defence", "Pharmaceuticals", "Automotive", "IT security firms"],
    equipment: ["Industrial firewall appliance", "Network switch with VLAN support", "OT testbed environment", "Jump server / bastion host", "Security monitoring workstation"],
    software: ["Wireshark / tcpdump", "Nmap vulnerability scanner", "IDS/IPS tools (Snort / Suricata)", "SIEM dashboard (ELK Stack basics)"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Solar EPC companies", "Wind energy firms", "Battery storage companies", "Power utilities", "Green hydrogen", "Rural electrification"],
    equipment: ["Solar PV panel training kit", "Grid-tie inverter trainer", "Battery storage module", "Wind turbine model", "Electrical safety test equipment"],
    software: ["PVsyst / solar sizing tools", "Inverter monitoring platforms", "Energy yield analysis tools", "Battery management software"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "Power plants", "Oil and gas", "Cement and steel", "FMCG", "Pharmaceuticals", "Mining"],
    equipment: ["Vibration analyser", "Thermal imaging camera", "Ultrasonic detector", "Motor test rig with sensors", "Oil analysis kits"],
    software: ["Vibration analysis software (CSI / SKF)", "Thermal imaging analysis tools", "Condition monitoring dashboards", "Reliability centred maintenance tools"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive OEMs", "Aerospace", "Pharmaceuticals", "Electronics", "Defence", "Medical devices", "Textiles"],
    equipment: ["CMM training unit", "Digital calipers and micrometers", "Optical comparator", "Surface roughness tester", "Hardness tester"],
    software: ["CMM measurement software", "SPC analysis tools", "Minitab / JMP statistical software", "CAD comparison tools"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "FMCG", "Pharmaceuticals", "Electronics", "Aerospace", "Steel and metals", "Consulting firms"],
    equipment: ["Value stream mapping boards", "5S audit kits", "Kaizen event toolkits", "Process mapping workstations", "OEE monitoring stations"],
    software: ["Excel / Google Sheets for analysis", "Visio / Lucidchart for mapping", "Power BI for KPI dashboards", "DMAIC project tracking tools"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Automotive", "Pharmaceuticals", "FMCG", "Energy", "Supply chain", "Electronics", "Process industries"],
    equipment: ["Data acquisition modules", "Sensor rigs for data collection", "Edge gateway for preprocessing", "PC workstations with Python", "Network-connected PLC simulator"],
    software: ["Python (pandas, NumPy, matplotlib)", "Grafana dashboards", "InfluxDB / TimescaleDB", "SQL databases", "Jupyter notebooks"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hiringIndustries: ["Aerospace", "Automotive", "Medical devices", "Defence", "Tool and die making", "Rapid prototyping services", "Research labs"],
    equipment: ["FDM 3D printer", "SLA resin printer", "CNC milling trainer", "Laser cutter/engraver", "Post-processing workstation"],
    software: ["Cura / PrusaSlicer for 3D printing", "Fusion 360 / CAM software", "CAD design tools", "Printer management software"],
    certification: "Finish the programme and you get a Veritas by IQgrads certification, with your learning aligned to Pearson's internationally recognised standards — real proof of what you can do.",
    published: true,
