...
export default function WhatsApp() {
  ...
  useEffect(() => {
    ...
    fetch("/api/whatsapp-settings")
      ...
      .then((data) => {
        ...
        setWhatsappHref(digits ? `https://wa.me/${digits}` : "");
      })
      .catch(() => {
        if (alive) setWhatsappHref("");
      });
  ...
  return (
    <>
      {whatsappHref ? (
        <a className="wa" aria-label="Chat on WhatsApp" href={whatsappHref} target="_blank" rel="noreferrer">
