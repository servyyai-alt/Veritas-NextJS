...
export default function ContactFormOrCrm() {
  ...
  if (iframeFailed) {
    return (
      <div className="form-card" style={{ textAlign: "center", padding: "40px 20px" }}>
        ...
        <p style={{ color: "#8A2434", fontSize: "15px", margin: "0 0 16px" }}>Unable to load CRM Contact Form.</p>
        <button
